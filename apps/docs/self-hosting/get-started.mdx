...
|          | [Typebot Cloud](https://app.zazubot.com)                                                                                                                                                                                                                                                                                                                        | Self-Hosting                                                                                                                                                                                                                                         |
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Support  | Premium direct support available on STARTER and PRO plans                                                                                                                                                                                                                                                                                                       | We don't offer support for your self-hosting issues that are not related to Typebot. You may reach out to the [Discord community](https://zazubot.com/discord) for support.                                                                          |
...
<Note>
  [Sponsoring the project](https://github.com/sponsors/baptisteArno) is a great
  way to give back to the community and to contribute to the long-term
  sustainability of the project. It also comes with some perks like priority
  support and private workshops. ❤️
</Note>
...
<Accordion title="Can I integrate the Typebot editor in my existing software?">
  ❌ **You legally cannot do this**. If you are selling your software,
  integrating the Typebot editor would mean competing against Typebot Cloud,
  which violates the project's license. However, you can use the code from two
  years ago, which is available under the Apache 2.0 license.
</Accordion>
...
The self-hosted version is somewhat of a LTS, you only get new release once a month. If you want features as soon as they are available, consider becoming a [cloud user](https://app.zazubot.com). New versions are published on the [releases page](https://github.com/baptisteArno/typebot.io/releases).
...
If you have any questions, feel free to reach out on the [Discord server](https://zazubot.com/discord) 🔥
