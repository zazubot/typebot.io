...
**[Benefits](./benefits-ai-chatbot.mdx) of Having a Chatbot on Your WordPress Site**
...
Now, let's talk about **Typebot**, the [chatbot builder](./best-chatbot-builder.mdx) that will simplify your life.
...
1. **Head Over to the WordPress Plugin Directory**: Go to the WordPress admin area. Navigate to Plugins > Add New.
   ![Wordpress Plugin Tab](/blog-assets/add-chatbot-to-wordpress/wordpress-plugin-tab.jpg)

2. **Search for Typebot**: Type “Typebot” in the search bar. Click “Install Now” once you find the official Typebot plugin.
   ![How to look for Typebot in the WordPress Plugin Directory](/blog-assets/add-chatbot-to-wordpress/typebot-wordpress-plugin-directory.jpg)

3. **Activate the Plugin**: After installation, click the “Activate” button. Typebot will now appear in your WordPress menu.
   ![Activate Typebot Plugin](/blog-assets/add-chatbot-to-wordpress/wordpress-typebot-activate.jpg)
...
1. **Access Typebot Settings**: In the WordPress admin area, go to Settings > Typebot.
   ![Typebot Settings](/blog-assets/add-chatbot-to-wordpress/wordpress-typebot-settings.jpg)
...
3. **Generate a Code Snippet**: Click on “Share” within Typebot. Select “WordPress” and click the "Get Code Snippet" button to generate your unique code.
   ![Generate Code Snippet](/blog-assets/add-chatbot-to-wordpress/typebot-share-wordpress.jpg)
...
4. **Paste the Code into WordPress**: Copy the snippet and paste it into the “Code Snippet” field in the Typebot settings on your WordPress site. Don’t forget to put ‘0.2’ in the Library version.
   ![Paste Code Snippet](/blog-assets/add-chatbot-to-wordpress/typebot-wordpress-filled-settings.jpg)
...
![Example of a live chatbot on WordPress](/blog-assets/add-chatbot-to-wordpress/typebot-chatbot-wordpress.jpg)
...
- **Buttons and Quick Replies**: Enhance interactivity with buttons for users to make selections without typing.
  ![Typebot integrations](/blog-assets/typebot-integrations.avif)
...
With a cohesive appearance, your chatbot will enhance user experience without feeling like an add-on. Go over the Theme tab to customize your Typebot. If you need help, you can check out [the documentation](https://docs.zazubot.com/theme/overview).
...
- **Personalization**: Use prefilled variables to tailor responses based on user data. For instance, greeting users by their names makes interactions warmer and more human-like. You can also use AI to [customize the chatbot with your data](./train-chatbot-on-your-own-data.mdx).
