...
The first step is to sign up for a free Typebot account at https://app.zazubot.com. This user-friendly platform allows you to create advanced conversational apps visually, without coding expertise.
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/typebot-blocks.jpg"
...
<Info>
  ...
  exampes](./chatbot-script-examples.mdx) to help you get started. There are
  best practices, tips, and prompts to help you create a successful chatbot.
</Info>
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/flow-first-message.jpg"
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/flow-first-ask.jpg"
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/flow-ask-email.jpg"
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/typebot-share-button.jpg"
...
2. Change the runtime to "WhatsApp."
   ...
   <Image
     src="/blog-assets/create-whatsapp-chatbot/typebot-preview-whatsapp.jpg"
...
3. On the “Use case” step, select “Other”
   ...
   <Image
     src="/blog-assets/create-whatsapp-chatbot/whatsapp-create-app-type.jpg"
...
4. On the next step, select Business
   ...
   <Image
     src="/blog-assets/create-whatsapp-chatbot/whatsapp-create-app-business.jpg"
...
5. Next step asks you about details of your app such as the name and your email
   ...
   <Image
     src="/blog-assets/create-whatsapp-chatbot/whatsapp-create-app-details.jpg"
...
4. Click on Add assets. Under Apps, look for your previously created app, select it and check Manage app
   <Image
     src="/blog-assets/create-whatsapp-chatbot/whatsapp-system-user-assets.png"
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/result-example.jpg"
...
<Info>
  ...
  together a [WhatsApp pricing calculator](./whatsapp-business-api-pricing.mdx)
  to help you estimate the cost of your WhatsApp chatbot.
</Info>

## Designing an Engaging WhatsApp Chatbot Experience

Now that you've set up the technical foundation for your WhatsApp chatbot, it's time to focus on crafting an engaging and memorable experience for your users. Here are some [best practices](./chatbot-best-practices.mdx) and strategies to consider:
...
<Image
  src="/blog-assets/create-whatsapp-chatbot/contact-var.png"
