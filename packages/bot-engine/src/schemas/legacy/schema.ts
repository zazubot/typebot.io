...
const startParamsSchema = z
  .object({
    typebot: startTypebotSchema
      .or(z.string())
      .describe(
        "Either a Typebot ID or a Typebot object. If you provide a Typebot object, it will be executed in preview mode. ([How can I find my typebot ID?](https://docs.zazubot.com/api-reference#how-to-find-my-typebotid)).",
      ),
    isPreview: z
      .boolean()
      .optional()
    ...
    prefilledVariables: z
      ...
      .optional()
      .describe(
        "[More info about prefilled variables.](https://docs.zazubot.com/editor/variables#prefilled-variables)",
      ),
    isStreamEnabled: z
      .boolean()
      .optional()
...
export const chatReplySchema = z.object({
  ...
  typebot: z
    .object({
      id: z.string(),
      theme: z.union([
        typebotV5Schema.shape.theme,
        typebotV6Schema.shape.theme,
      ]),
      settings: z.union([
        typebotV5Schema.shape.settings,
